...
Usage()
{
    ...
    builtin echo "\t\tAvailable          = [4.3 | 5.0 | 5.1 | 6.0 | 7.0 | 8.1]"
...
CleanDeployedLibrary BDKit
CleanDeployedLibrary BDUIKit

BuildLibrary $LIBRARIES_ROOT BDKit BDKit
BuildLibrary $LIBRARIES_ROOT BDUIKit BDUIKit